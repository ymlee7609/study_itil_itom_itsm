...
3. **실무 프로세스**: Incident vs Problem vs Known Error → Service Request vs Incident → Event vs Alert vs Incident → Change vs Release vs Deployment → Workaround vs Fix vs Resolution
...
- 총 22개 문서
- P1: 10개, P2: 10개, P3: 3개 (※ Output vs Outcome은 P1 포함)
...
| 개발·운영 협업 갭 해소 | Change/Release/Deployment, Event/Alert/Incident |
| SLA 협상·재설계 | SLA/OLA/UC/XLA, Utility/Warranty, RTO/RPO |
| 감사·컴플라이언스 대응 | Governance/Management, Policy/Standard, CI/Asset |
